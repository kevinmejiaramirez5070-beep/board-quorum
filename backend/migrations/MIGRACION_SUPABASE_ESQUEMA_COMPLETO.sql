/*
  BOARD QUORUM - ESQUEMA COMPLETO PARA SUPABASE
...
-- Tabla de clientes (organizaciones)
...
-- Tabla de productos (órganos: Junta Directiva, Asamblea General, etc.)
CREATE TABLE IF NOT EXISTS products (
  id SERIAL PRIMARY KEY,
  client_id INTEGER NOT NULL,
  name VARCHAR(255) NOT NULL,
  description TEXT,
  quorum_rule VARCHAR(100) DEFAULT 'simple',
  quorum_value VARCHAR(50) NULL,
  voting_rule VARCHAR(100) DEFAULT 'simple_majority',
...
-- Tabla de miembros (con columnas para quórum y votación)
CREATE TABLE IF NOT EXISTS members (
  ...
  rol_organico VARCHAR(100) NULL,
  tipo_participante VARCHAR(50) NULL,
  rol_en_votacion VARCHAR(50) NULL,
  cuenta_quorum BOOLEAN DEFAULT true,
...
-- Tabla de asistencia (con campos para registro manual/verificación)
CREATE TABLE IF NOT EXISTS attendance (
  ...
  manual_position VARCHAR(255) NULL,
  manual_document VARCHAR(50) NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- Tabla de contactos (formulario web)

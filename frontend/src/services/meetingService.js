...
export const meetingService = {
  ...
  getMomentoSiguiente: (id) => api.get(`/meetings/${id}/assembly-quorum/momento-siguiente`),
  applyMomentoSiguiente: (id) => api.post(`/meetings/${id}/assembly-quorum/momento-siguiente`, { confirmado: true }),
  // M6 — Orden del Día
